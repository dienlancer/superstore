...
$inputCode              =   '<input type="text" class="form-control" name="code"      value="'.@$arrRowData['code'].'">'; 
            ...
            <div class="form-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-2 control-label"><b>Màu</b></label>
                        <div class="col-md-10">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-2 control-label"><b>Mã màu</b></label>
                        <div class="col-md-10">
                            <?php echo $inputCode; ?>
                            <span class="help-block"></span>
                        </div>
