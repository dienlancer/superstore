...
class ProductController extends Controller {  
  ...
  public function getList(){
    ...
    return view("frontend.index",compact("component","layout","arrCategoryProductRecursive"));
  }  
  ...
  public function getForm($task,$id=""){     
    ...
    $arrCategoryProductRecursive=array();
    categoryRecursiveForm($arrCategoryProduct ,0,"",$arrCategoryProductRecursive)   ;    
    return view("frontend.index",compact("component","layout","arrCategoryProductRecursive","arrRowData","task"));
  }
